...
IMAGE_PATH = r"assets\Aruco marker\20mm\Image (8).jpg"
...
def apply_robot_offset(step):
    return {
        **step,
        "x_mm": step["x_mm"] + ROBOT_ORIGIN_OFFSET_X_MM,
        "y_mm": step["y_mm"] + ROBOT_ORIGIN_OFFSET_Y_MM,
    }
...
def main():
    ...
    print(f"[RUN] Solver Input: {warped_path}")
